	...
	<div class="content">
		<div class="container">
			...
			<div class="typewriter">
				...
				<h4 style="color:red;" align="center">Mentor Login</h4>
			
				<div class="widget-body">
					<div>
						<div class="center-align">
							<form onsubmit="return validateRegister();" name="mentor" class="form-horizontal form-signin-signup" action="login"
								method="post">
								...
								<div>
									<h5>Click Here to New &nbsp;<a href="registration.jsp">Mentor Registration</a></h5>
								</div>
							</form>
						</div>
					</div>
