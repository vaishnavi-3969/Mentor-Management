...
<head>
        <style>
          body {
	background-image: linear-gradient(to right, #DAFFED, #B7B5E4);
          }
...
<script type="text/javascript" src="js/boot-business.js"></script>
	...
	<div class="content">
		<div class="container">
			<div class="row">
				<h4 align="center">Mentor Registration</h4>
				<div class="widget-body">
					<div>
						<div class="center-align">
							<form onsubmit="return validateRegister();" name="mentor" class="form-horizontal form-signin-signup" action="register"
								method="post">
