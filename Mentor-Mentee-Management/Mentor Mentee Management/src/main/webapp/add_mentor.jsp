...
<body background="image/images.jpg">
	...
	<div class="content">
		<div class="container">
			<div class="row">
				<h4 align="center">Add Mentor</h4>
				<div class="widget-body">
					<div>
						<div class="center-align">
							<form onsubmit="return validateRegister();" name="mentor"
								class="form-horizontal form-signin-signup" action="mentor"
								method="post">
								...
								<fieldset>
									<table border="1" width="90%" cellpadding="1" cellspacing="1"
										...
										<tr bgcolor="#778899" style="height: 30px;">
											<td><font size="2" color="white"><center>
														<b>Name</b>
													</center></font></td>
											<td><font size="2" color="white"><center>
														<b> Contact</b>
										...
										<%
											...
											ResultSet rs = st
													.executeQuery("select *  from  mentor_registration");
											while (rs.next()) {
										%>
